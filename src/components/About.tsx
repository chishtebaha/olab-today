  ...
  return (
    <section id="about" className="section-block p-8 md:p-12">
      <div className="text-center mb-16">
        <h2 className="text-4xl font-light text-white mb-4">About Us</h2>
        ...
        >
          <div className="aspect-w-16 aspect-h-9">
            <img
              ...
              className="object-cover rounded-lg shadow-lg border border-gray-800"
            />
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-start space-x-4 p-6 rounded-lg border border-gray-800 bg-gray-900/30 hover:border-gray-700 transition-colors"
            >
