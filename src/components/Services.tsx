    ...
    <section id="services" className="section-block p-8 md:p-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-gray-800/50 border border-gray-700 rounded-xl p-8 hover:border-[#ff6b00] transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
